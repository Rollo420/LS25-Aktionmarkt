<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Erstelle eine neue Farm</h1>
            ...
            <form action="{{route('farm.sendNewFarm')}}" method="POST">
                ...
                {{-- Farm Name --}}
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">Farm-Name</label>
                    <input type="text" name="name" id="name" placeholder="Meine tolle Farm" value="{{ old('name') }}"
                ...
                {{-- Beschreibung --}}
                <div class="mb-4">
                    <label for="description" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">Beschreibung</label>
                    <textarea name="description" id="description" rows="4" placeholder="Beschreibe deine Farm..."
