            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="relative">
                    <x-dropdown align="right" width="32">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link href="{{ route('lang.switch', 'de') }}" class="flex items-center gap-2 {{ app()->getLocale() == 'de' ? 'bg-gray-100 dark:bg-gray-600' : '' }}">
                                <span class="text-xs">🇩🇪</span>
                                {{ __('language.de') }}
                            </x-dropdown-link>
                            <x-dropdown-link href="{{ route('lang.switch', 'en') }}" class="flex items-center gap-2 {{ app()->getLocale() == 'en' ? 'bg-gray-100 dark:bg-gray-600' : '' }}">
                                <span class="text-xs">🇺🇸</span>
                                {{ __('language.en') }}
                            </x-dropdown-link>
                            <x-dropdown-link href="{{ route('lang.switch', 'nl') }}" class="flex items-center gap-2 {{ app()->getLocale() == 'nl' ? 'bg-gray-100 dark:bg-gray-600' : '' }}">
                                <span class="text-xs">🇳🇱</span>
                                {{ __('language.nl') }}
                            </x-dropdown-link>
                        </x-slot>
