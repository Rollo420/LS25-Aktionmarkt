                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3"
                                          class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-900 dark:text-gray-100">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.001" name="volatility_range" id="volatility_range" value="{{ old('volatility_range', 0.04) }}" required min="0" max="1"
                                       class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-900 dark:text-gray-100">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.001" name="seasonal_effect_strength" id="seasonal_effect_strength" value="{{ old('seasonal_effect_strength', 0.026) }}" required min="0" max="1"
                                       class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-900 dark:text-gray-100">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.1" name="crash_probability_monthly" id="crash_probability_monthly" value="{{ old('crash_probability_monthly', 1) }}" required min="0"
                                       class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-900 dark:text-gray-100">
                            ...
                            <div>
                                ...
                                <input type="number" name="crash_interval_months" id="crash_interval_months" value="{{ old('crash_interval_months', 240) }}" required min="1"
                                       class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-900 dark:text-gray-100">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.1" name="rally_probability_monthly" id="rally_probability_monthly" value="{{ old('rally_probability_monthly', 1) }}" required min="0"
                                       class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-900 dark:text-gray-100">
                            ...
                            <div>
                                ...
                                <input type="number" name="rally_interval_months" id="rally_interval_months" value="{{ old('rally_interval_months', 360) }}" required min="1"
                                       class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-900 dark:text-gray-100">
