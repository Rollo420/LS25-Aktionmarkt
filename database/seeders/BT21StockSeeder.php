...
Mit ihrem umfassenden Macht-Netzwerk gilt Try Soft als wirtschaftliche Supermacht, deren Entscheidungen ganze Märkte und Regierungen formen.',
   ...
   [
       ...
       'land' => 'USA',
       'description' => 'GreenBale ist ein führendes Unternehmen in der Herstellung von Grasssilage für die Landwirtschaft. Das Unternehmen produziert hochwertige Silageprodukte, die als Futtermittel für Nutztiere verwendet werden, um deren Gesundheit und Produktivität zu verbessern. GreenBale setzt auf nachhaltige Anbaumethoden und modernste Verarbeitungstechnologien, um erstklassige Silage zu gewährleisten.',
       'net_income' => 2250000,
       'dividend_frequency' => 0
   ],
   [
       ...
       'land' => 'Canada',
       'description' => 'SolarWind Dynamics ist ein führendes Unternehmen im Bereich der erneuerbaren Energien, das sich auf die Entwicklung, den Bau und den Betrieb von Solar- und Windkraftanlagen spezialisiert hat. Das Unternehmen bietet nachhaltige Energie Lösungen für private, gewerbliche und industrielle Kunden an und trägt zur Reduzierung der CO2-Emissionen bei.',
       'net_income' => 1100000,
       'dividend_frequency' => 0
   ],
   [
   ...
   [
       'name' => 'Fendt Holding SbR',
       'firma' => 'Fentd Holding SbR',
       'sektor' => 'Landwirtschaftliches Multikonzern',
       'land' => 'Germany',
       'description' => 'Fendt Holding SbR ist ein führender landwirtschaftlicher Multikonzern mit Sitz in Deutschland. Das Unternehmen ist spezialisiert auf die Entwicklung, Herstellung und den Vertrieb von hochwertigen Landmaschinen und landwirtschaftlichen Lösungen. Mit einer breiten Produktpalette, die Traktoren, Mähdrescher, Pflüge und Sämaschinen umfasst, bedient Fendt Holding SbR Landwirte weltweit und trägt zur Effizienzsteigerung und Nachhaltigkeit in der Landwirtschaft bei.',
       'net_income' => 1460000,
       'dividend_frequency' => 2
   ],
   [
       'name' => 'EDA Foods Inc.',
       'firma' => 'MeadowGroe Inc.',
       'sektor' => 'Lebensmittelproduktion',
       'land' => 'USA',
       'description' => 'EDA Foods Inc. ist ein führendes Unternehmen in der Lebensmittelproduktion mit Sitz in den USA. Das Unternehmen spezialisiert sich auf die Herstellung und den Vertrieb von hochwertigen Lebensmitteln, die auf nachhaltigen und umweltfreundlichen Produktionsmethoden basieren. Mit einem breiten Sortiment an Produkten, die von frischen Lebensmitteln bis hin zu verarbeiteten Nahrungsmitteln reichen, bedient EDA Foods Inc. Kunden weltweit und setzt sich für gesunde Ernährung und Lebensqualität ein.',
       'net_income' => 2250000,
       'dividend_frequency' => 0
   ],
   [
       'name' => 'DDvOfj.',
       'firma' => 'Back To 21 Holding AG',
       'sektor' => 'Hundezucht und Hundevermittlung',
       'land' => 'Germany',
       'description' => 'DDvOfj. ist ein renommiertes Unternehmen, das sich auf die Zucht, Ausbildung und Vermittlung von Hunden spezialisiert hat. Mit langjähriger Erfahrung und einem engagierten Team von Züchtern und Trainern bietet DDvOfj. hochwertige Hunde für Familien, Züchter und Hundeliebhaber weltweit an. Das Unternehmen legt großen Wert auf Gesundheit, Temperament und soziale Anpassungsfähigkeit der Hunde und setzt sich für verantwortungsvolle Hundehaltung ein.',
       'net_income' => 3200000,
       'dividend_frequency' => 0
   ],
   [
       'name' => 'LS500',
       'firma' => 'Casinos Global AG',
       'sektor' => 'Glücksspiel und Unterhaltung',
       'land' => 'USA',
       'description' => 'LS500 ist ein führendes Unternehmen in der Glücksspiel- und Unterhaltungsbranche mit Sitz in den USA. Das Unternehmen betreibt eine Vielzahl von Casinos, Online-Glücksspielplattformen und Unterhaltungszentren weltweit. Mit einem Fokus auf erstklassige Kundenerlebnisse, innovative Spiele und verantwortungsbewusstes Glücksspiel setzt LS500 Maßstäbe in der Branche und bietet seinen Kunden spannende Unterhaltungsmöglichkeiten.',
       'net_income' => 12500000,
       'dividend_frequency' => 0
   ],
   [
       'name' => 'Pflege für Alle GmbH',
       'firma' => 'Mühl und Schröder Investments',
       'sektor' => 'Non-Profit',
       'land' => 'Global',
       'description' => 'Pflege für Alle GmbH ist eine gemeinnützige Organisation, die sich der Bereitstellung von Pflege- und Gesundheitsdienstleistungen für bedürftige Gemeinschaften weltweit widmet. Mit einem engagierten Team von Fachkräften arbeitet Pflege für Alle GmbH daran, den Zugang zu qualitativ hochwertiger Pflege zu verbessern, Bildungsprogramme zu fördern und nachhaltige Gesundheitsinitiativen zu unterstützen. Die Organisation setzt sich für das Wohlbefinden und die Lebensqualität von Menschen in Not ein.',
       'net_income' => 0,
       'dividend_frequency' => 12
   ],
   [
       'name' => 'CannaHealth Group',
       'firma' => 'CannaHealth Group',
       'sektor' => 'Hanfherstellung und -vertrieb',
       'land' => 'Germany',
       'description' => 'CannaHealth Group ist ein führendes Unternehmen in der Hanfherstellungs- und Vertriebsbranche mit Sitz in Deutschland. Das Unternehmen spezialisiert sich auf die Produktion, Verarbeitung und den Vertrieb von hochwertigen Hanfprodukten, darunter medizinisches Cannabis, CBD-Produkte und Hanfbasierte Wellnessartikel. Mit modernster Anbau- und Verarbeitungstechnologie stellt CannaHealth Group sicher, dass seine Produkte den höchsten Qualitätsstandards entsprechen und den Bedürfnissen der Kunden gerecht werden.',
       'net_income' => 3000000,
       'dividend_frequency' => 1
   ],
   [
       'name' => 'Max-Dividend Corp.',
       'firma' => 'Mühl und Schröder Investments',
       'sektor' => 'Non-Profit',
       'land' => 'France',
